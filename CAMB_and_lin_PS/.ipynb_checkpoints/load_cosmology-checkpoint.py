...
def load_cosmology_input(params_path):
    ...
    for line in file:
        ...
        if line[0] == '\n':
        ...
        elif line[0].strip() == 'mnu':
            cosmo_dic['mnu'] = eval(line[1].strip())
            cosmo_dic['omega_nu_0'] = cosmo_dic['mnu']/(93.14)
            cosmo_dic['omega_d_0'] = total_dark - cosmo_dic['omega_nu_0']
            cosmo_dic['omega_db_0'] = cosmo_dic['omega_d_0'] + cosmo_dic['omega_b_0']
            cosmo_dic['omega_m_0'] = cosmo_dic['omega_db_0'] + cosmo_dic['omega_nu_0']
        elif line[0].strip() == 'h':
            ...
            cosmo_dic['Omega_nu_0'] = cosmo_dic['omega_nu_0']/cosmo_dic['h']**2
        ...
        elif line[0].strip() == 'massive_neutrinos':
            cosmo_dic['massive_neutrinos'] = eval(line[1].strip())
