...
def func_R_nonlin_2(cosmo_dic, k, PS, LCDM=True):
    """
...
def func_alpha_param(cosmo_dic, k, PS_cold, LCDM=True):
    ...
    R_nonlin = func_R_nonlin_2(cosmo_dic, k, PS_cold, LCDM=LCDM)
    ln_R = np.log(R)
...
def HMCode_param_dic(cosmo_dic, k_sigma, PS_cold_sigma, LCDM=True):
    """
    ...
    param_model_dic['alpha'] = func_alpha_param(cosmo_dic, k_sigma, PS_cold_sigma, LCDM=LCDM)
